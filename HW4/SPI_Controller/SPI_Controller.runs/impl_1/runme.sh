...
HD_PWD='E:/Project/SPI_Controller/SPI_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spiControl_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spiControl_FSM.tcl -notrace
