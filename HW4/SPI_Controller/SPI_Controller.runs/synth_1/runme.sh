...
HD_PWD='E:/Project/SPI_Controller/SPI_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spiControl_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spiControl_FSM.tcl
