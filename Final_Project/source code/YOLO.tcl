...
set rc [catch {
  ...
  set_property webtalk.parent_dir E:/Project/Final/Yolo_demo_vivado/Yolo_demo_vivado.cache/wt [current_project]
  set_property parent.project_path E:/Project/Final/Yolo_demo_vivado/Yolo_demo_vivado.xpr [current_project]
  set_property ip_repo_paths E:/Project/Final/Yolo_demo/solution1/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo E:/Project/Final/Yolo_demo_vivado/Yolo_demo_vivado.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet E:/Project/Final/Yolo_demo_vivado/Yolo_demo_vivado.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files E:/Project/Final/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
  read_xdc E:/Project/Final/yolov2_xilinx_fpga-master/vivado/PYNQ-Z1_C.xdc
  set_param project.isImplRun true
